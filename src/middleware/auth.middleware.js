...
function authMiddleware(request, response, next) {
    return __awaiter(this, void 0, void 0, function () {
        var token, secret, verification, id, user, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    next(new http_exception_1["default"](401, "Wrong authentication token: ".concat(error_1)));
                    return [3 /*break*/, 4];
                case 4: return [3 /*break*/, 6];
                case 5:
                    next(new http_exception_1["default"](403, 'Tu peticion no tiene cabecera de autorizacion'));
                    _a.label = 6;
